/**
 * Merchant database for UK transaction enrichment.
 * Maps common transaction descriptions to merchant names and categories.
 */
...
const MERCHANTS = [
  ...
  { patterns: ['sky digital'], merchant: 'Sky', category: 'Bills' },
...
/**
 * Match a transaction description to a known merchant.
 * Returns { merchant, category, isSubscription, isBNPL, isDebt, isIncome } or null.
 */
export function matchMerchant(description) {
...
/**
 * Detect if a description looks like a person-to-person transfer.
 */
export function isPersonTransfer(description) {
